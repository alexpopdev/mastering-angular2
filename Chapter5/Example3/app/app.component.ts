    ...
    <div class="row">
      <div class="col-md-12">
        <p>
          ...
          <input id="message-input" type="text" [(ngModel)]="message">
         </p>
         <p>
...
export class AppComponent{
  ...
  constructor() {
    this.title = 'Mastering Angular 2 - Chapter 5, Example 3';
    this.description = 'This is an example for built in structural directives.';
  }
